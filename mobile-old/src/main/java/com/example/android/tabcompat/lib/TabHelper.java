...
/**
 * Convenience helper to build a set of tabs for a {@link TabCompatActivity}. To
 * use this class, extend {@link TabCompatActivity} and:
 * 
...
public abstract class TabHelper {
     ...
     * TabCompatActivity instantiates one. Instead call
